...
//float4 fillColor 4384
//float2 surfaceUVCoords 4400
//float Port_Value_N001 4408
//float2 Port_uvPosition_N000 4416
//float depthRef 4424
//}
...
float4 param_3=(*sc_set0.UserUniforms).fillColor;
Output_N3=param_3;
float2 Output_N2=float2(0.0);
float2 param_4=(*sc_set0.UserUniforms).surfaceUVCoords;
Output_N2=param_4;
float3 Scale_N5=float3(0.0);
float4x4 l9_1=(*sc_set0.UserUniforms).sc_ModelMatrix;
float3 param_5=float3(length(l9_1[0].xyz),length(l9_1[1].xyz),length(l9_1[2].xyz));
Scale_N5=param_5;
float4 Output_N0=float4(0.0);
float param_6=Output_N1;
float4 param_7=Output_N3;
float2 param_8=Output_N2;
float3 param_9=Scale_N5;
float2 param_10=(*sc_set0.UserUniforms).Port_uvPosition_N000;
float4 param_11=float4(0.0);
N0_radius=param_6;
N0_fillColor=param_7;
N0_surfaceUVCoords=param_8;
N0_surfaceWorldScale=param_9;
N0_uvPosition=param_10;
float l9_2=N0_surfaceWorldScale.x/N0_surfaceWorldScale.y;
float2 l9_3=N0_surfaceUVCoords-N0_uvPosition;
float2 l9_4=float2(l9_3.x,l9_3.y/l9_2);
float l9_5=length(l9_4)-N0_radius;
float l9_6=step(l9_5,0.0);
N0_Output=N0_fillColor*l9_6;
param_11=N0_Output;
Output_N0=param_11;
...
float4 l9_10=fast::max(param_13,float4(0.0));
float4 param_14=l9_10;
if (sc_ShaderCacheConstant_tmp!=0)
{
