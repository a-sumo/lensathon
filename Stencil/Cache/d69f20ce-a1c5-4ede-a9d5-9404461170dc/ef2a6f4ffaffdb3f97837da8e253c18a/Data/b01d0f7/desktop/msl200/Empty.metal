...
float4 param_4=(*sc_set0.UserUniforms).Port_fillColor_N000;
float2 param_5=(*sc_set0.UserUniforms).Port_surfaceUVCoords_N000;
float3 param_6=(*sc_set0.UserUniforms).Port_surfaceWorldScale_N000;
float2 param_7=(*sc_set0.UserUniforms).Port_uvPosition_N000;
float4 param_8=float4(0.0);
N0_radius=param_3;
N0_fillColor=param_4;
N0_surfaceUVCoords=param_5;
N0_surfaceWorldScale=param_6;
N0_uvPosition=param_7;
...
float4 l9_9=fast::max(param_10,float4(0.0));
float4 param_11=l9_9;
if (sc_ShaderCacheConstant_tmp!=0)
{
