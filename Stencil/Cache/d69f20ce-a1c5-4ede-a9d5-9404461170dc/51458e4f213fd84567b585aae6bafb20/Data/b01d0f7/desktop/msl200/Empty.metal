...
//float2 uvPosition 4400
//float Port_Value_N001 4408
//float2 Port_surfaceUVCoords_N000 4416
//float3 Port_surfaceWorldScale_N000 4432
//float depthRef 4448
//}
...
float2 param_4=(*sc_set0.UserUniforms).uvPosition;
Output_N2=param_4;
float4 Output_N0=float4(0.0);
float param_5=Output_N1;
float4 param_6=Output_N3;
float2 param_7=(*sc_set0.UserUniforms).Port_surfaceUVCoords_N000;
float3 param_8=(*sc_set0.UserUniforms).Port_surfaceWorldScale_N000;
float2 param_9=Output_N2;
float4 param_10=float4(0.0);
N0_radius=param_5;
N0_fillColor=param_6;
N0_surfaceUVCoords=param_7;
N0_surfaceWorldScale=param_8;
N0_uvPosition=param_9;
...
float4 l9_9=fast::max(param_12,float4(0.0));
float4 param_13=l9_9;
if (sc_ShaderCacheConstant_tmp!=0)
{
