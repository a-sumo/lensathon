...
//float Port_Value_N001 4400
//float2 Port_surfaceUVCoords_N000 4408
//float3 Port_surfaceWorldScale_N000 4416
//float2 Port_uvPosition_N000 4432
//float depthRef 4440
//}
...
float2 Port_surfaceUVCoords_N000;
float3 Port_surfaceWorldScale_N000;
float2 Port_uvPosition_N000;
float depthRef;
};
struct sc_Bone_t
{
...
main_frag_out out={};
float N0_radius=0.0;
float4 N0_fillColor=float4(0.0);
float2 N0_surfaceUVCoords=float2(0.0);
float3 N0_surfaceWorldScale=float3(0.0);
float2 N0_uvPosition=float2(0.0);
float4 N0_Output=float4(0.0);
...
float Output_N1=0.0;
float param_1=(*sc_set0.UserUniforms).Port_Value_N001;
float param_2=param_1+0.001;
param_2-=0.001;
Output_N1=param_2;
float4 Output_N3=float4(0.0);
float4 param_3=(*sc_set0.UserUniforms).Tweak_N3;
Output_N3=param_3;
float4 Output_N0=float4(0.0);
float param_4=Output_N1;
float4 param_5=Output_N3;
float2 param_6=(*sc_set0.UserUniforms).Port_surfaceUVCoords_N000;
float3 param_7=(*sc_set0.UserUniforms).Port_surfaceWorldScale_N000;
float2 param_8=(*sc_set0.UserUniforms).Port_uvPosition_N000;
float4 param_9=float4(0.0);
N0_radius=param_4;
N0_fillColor=param_5;
N0_surfaceUVCoords=param_6;
N0_surfaceWorldScale=param_7;
N0_uvPosition=param_8;
float l9_1=N0_surfaceWorldScale.x/N0_surfaceWorldScale.y;
float2 l9_2=N0_surfaceUVCoords-N0_uvPosition;
float2 l9_3=float2(l9_2.x,l9_2.y/l9_1);
float l9_4=length(l9_3)-N0_radius;
float l9_5=step(l9_4,0.0);
N0_Output=N0_fillColor*l9_5;
param_9=N0_Output;
Output_N0=param_9;
...
float4 l9_9=fast::max(param_11,float4(0.0));
float4 param_12=l9_9;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
int l9_44=l9_39;
float2 l9_45=l9_37;
int l9_46=sc_ScreenTextureLayout_tmp;
int l9_47=l9_44;
float l9_48=l9_38;
float2 l9_49=l9_45;
int l9_50=l9_46;
...
if (l9_50==0)
{
l9_52=float3(l9_49,0.0);
}
else
{
if (l9_50==1)
{
l9_52=float3(l9_49.x,(l9_49.y*0.5)+(0.5-(float(l9_51)*0.5)),0.0);
}
else
{
l9_52=float3(l9_49,float(l9_51));
}
}
float3 l9_53=l9_52;
float3 l9_54=l9_53;
float4 l9_55=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_54.xy,bias(l9_48));
float4 l9_56=l9_55;
float4 l9_57=l9_56;
l9_20=l9_57;
}
float4 l9_58=l9_20;
float3 l9_59=l9_58.xyz;
float3 l9_60=l9_59;
float3 l9_61=l9_18.xyz;
float3 l9_62=definedBlend(l9_60,l9_61,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_19=float4(l9_62.x,l9_62.y,l9_62.z,l9_19.w);
float3 l9_63=mix(l9_59,l9_19.xyz,float3(l9_18.w));
...
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_65=float4(in.varScreenPos.xyz,1.0);
param_13=l9_65;
}
else
{
...
float l9_67=fast::clamp(abs(l9_66.z),0.0,1.0);
float4 l9_68=float4(l9_67,1.0-l9_67,1.0,1.0);
param_13=l9_68;
}
else
{
float4 l9_69=param_13;
