...
//float4 Port_strokeColor_N000 4416
//float2 Port_surfaceUVCoords_N000 4432
//float3 Port_surfaceWorldScale_N000 4448
//float2 Port_uvPosition_N000 4464
//float depthRef 4472
//}
...
main_frag_out out={};
float N0_radius=0.0;
float N0_strokeWidth=0.0;
float4 N0_fillColor=float4(0.0);
float4 N0_strokeColor=float4(0.0);
...
Output_N1=param_2;
float Output_N2=0.0;
float param_3=(*sc_set0.UserUniforms).Port_Value_N002;
...
float4 param_7=(*sc_set0.UserUniforms).Port_fillColor_N000;
float4 param_8=(*sc_set0.UserUniforms).Port_strokeColor_N000;
float2 param_9=(*sc_set0.UserUniforms).Port_surfaceUVCoords_N000;
float3 param_10=(*sc_set0.UserUniforms).Port_surfaceWorldScale_N000;
float2 param_11=(*sc_set0.UserUniforms).Port_uvPosition_N000;
float4 param_12=float4(0.0);
N0_radius=param_5;
N0_strokeWidth=param_6;
N0_fillColor=param_7;
N0_strokeColor=param_8;
N0_surfaceUVCoords=param_9;
N0_surfaceWorldScale=param_10;
N0_uvPosition=param_11;
...
float2 l9_4=l9_3;
float l9_5=N0_radius;
float l9_6=length(l9_4)-l9_5;
float l9_7=l9_6;
float l9_8=step(l9_7,0.0);
float l9_9=fast::max(N0_radius-N0_strokeWidth,0.0);
float2 l9_10=l9_3;
float l9_11=l9_9;
float l9_12=length(l9_10)-l9_11;
float l9_13=l9_12;
float l9_14=step(l9_13,0.0);
float l9_15=l9_8-l9_14;
float l9_16=l9_14;
float4 l9_17=N0_fillColor*l9_16;
float4 l9_18=N0_strokeColor*l9_15;
N0_Output=l9_17+l9_18;
param_12=N0_Output;
Output_N0=param_12;
...
float4 l9_22=fast::max(param_14,float4(0.0));
float4 param_15=l9_22;
if (sc_ShaderCacheConstant_tmp!=0)
{
