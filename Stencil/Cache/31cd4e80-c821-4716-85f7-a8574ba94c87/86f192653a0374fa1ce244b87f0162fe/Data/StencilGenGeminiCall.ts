...
export class ExampleGeminiImageGen extends BaseScriptComponent {
  ...
  @input
  private snapCloudRequirements: SnapchatCloudRequirements;
  @input
  ...
  private setupButton() {
    if (this.generateButton) {
      this.generateButton.onTriggerUp.add(() => {
        print("Button pressed - calling edge function...");
        this.callEdgeFunction();
      });
      print("Generate button configured");
    } else {
      print("No button assigned - call callEdgeFunction() manually");
    }
  }
